...
public final class ADesConstDeclaracao extends PDeclaracao
{
    private PDeclaracaoConstante _declaracaoConstante_;

    public ADesConstDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADesConstDeclaracao(
    ...
    {
        ((Analysis) sw).caseADesConstDeclaracao(this);
    }
