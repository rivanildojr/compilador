...
public final class AMultiploDecDeclaracaoList extends PDeclaracaoList
{
    private PDeclaracaoList _declaracaoList_;
    private PDeclaracao _declaracao_;

    public AMultiploDecDeclaracaoList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiploDecDeclaracaoList(
    ...
    {
        ((Analysis) sw).caseAMultiploDecDeclaracaoList(this);
    }
