...
public final class AInteiroInicioNInteiroInicio extends PNInteiroInicio
{
    private TNInteiro _nInteiro_;

    public AInteiroInicioNInteiroInicio()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInteiroInicioNInteiroInicio(
    ...
    {
        ((Analysis) sw).caseAInteiroInicioNInteiroInicio(this);
    }
