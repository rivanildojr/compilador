...
public final class ASimplesDecDeclaracaoList extends PDeclaracaoList
{
    private PDeclaracao _declaracao_;

    public ASimplesDecDeclaracaoList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimplesDecDeclaracaoList(
    ...
    {
        ((Analysis) sw).caseASimplesDecDeclaracaoList(this);
    }
