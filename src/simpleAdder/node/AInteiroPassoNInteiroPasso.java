...
public final class AInteiroPassoNInteiroPasso extends PNInteiroPasso
{
    private TNInteiro _nInteiro_;

    public AInteiroPassoNInteiroPasso()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInteiroPassoNInteiroPasso(
    ...
    {
        ((Analysis) sw).caseAInteiroPassoNInteiroPasso(this);
    }
