...
public final class ASimplesDeclaracaoList extends PDeclaracaoList
{
    private PDeclaracao _declaracao_;

    public ASimplesDeclaracaoList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimplesDeclaracaoList(
    ...
    {
        ((Analysis) sw).caseASimplesDeclaracaoList(this);
    }
