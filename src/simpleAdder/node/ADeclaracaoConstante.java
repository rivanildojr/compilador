...
public final class ADeclaracaoConstante extends PDeclaracaoConstante
{
    ...
    public Object clone()
    {
        return new ADeclaracaoConstante(
    ...
    {
        ((Analysis) sw).caseADeclaracaoConstante(this);
    }
