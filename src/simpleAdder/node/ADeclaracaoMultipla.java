...
public final class ADeclaracaoMultipla extends PDeclaracaoMultipla
{
    ...
    public Object clone()
    {
        return new ADeclaracaoMultipla(
    ...
    {
        ((Analysis) sw).caseADeclaracaoMultipla(this);
    }
