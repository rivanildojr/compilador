...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTEsqParentese(@SuppressWarnings("unused") TEsqParentese node)
    {
        this.index = 21;
    }

    @Override
    public void caseTDirParentese(@SuppressWarnings("unused") TDirParentese node)
    {
        this.index = 22;
    }
    ...
    @Override
    public void caseTAspasDupla(@SuppressWarnings("unused") TAspasDupla node)
    {
        this.index = 24;
    }
    ...
    @Override
    public void caseTComentarioBlocoCorpo(@SuppressWarnings("unused") TComentarioBlocoCorpo node)
    {
        this.index = 58;
    }
