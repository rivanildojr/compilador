...
public interface Analysis extends Switch
{
    ...
    void caseADecSimplesDeclaracao(ADecSimplesDeclaracao node);
    void caseADecMultiploDeclaracao(ADecMultiploDeclaracao node);
    void caseADesConstDeclaracao(ADesConstDeclaracao node);
    void caseADeclaracaoSDeclaracaoSimple(ADeclaracaoSDeclaracaoSimple node);
    ...
    void caseASomaExpAritmetrica(ASomaExpAritmetrica node);
    void caseAMenosExpAritmetrica(AMenosExpAritmetrica node);
    void caseATermoExpAritmetrica(ATermoExpAritmetrica node);
    void caseAMultTermoAritmetrico(AMultTermoAritmetrico node);
    void caseADivTermoAritmetrico(ADivTermoAritmetrico node);
    void caseAFatorTermoAritmetrico(AFatorTermoAritmetrico node);
    void caseAExpParentesesFatorAritmetrico(AExpParentesesFatorAritmetrico node);
    void caseAValorFatorAritmetrico(AValorFatorAritmetrico node);
    void caseAMenosFatorAritmetrico(AMenosFatorAritmetrico node);
